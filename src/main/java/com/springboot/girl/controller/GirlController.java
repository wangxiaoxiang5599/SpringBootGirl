...
public class GirlController {
	...
	// @ApiImplicitParam(name = "id", value = "女生id", required = true, dataType =
	 ...
	 * 
	 * @PostMapping(value = "/girls") public Result<Girl>
	 * girlAdd(@RequestParam("cupSize") String cupSize,
	 * 
	 * @RequestParam("age") Integer age,
	 * 
	 * @RequestParam("money") Long money) { Girl girl = new Girl();
	 * girl.setCupSize(cupSize); girl.setAge(age); girl.setMoney(money);
	 * girlRepository.save(girl); Result<Girl> girlResult = new Result<Girl>();
	 * girlResult.setCode(0); girlResult.setMessage("成功"); girlResult.setData(girl);
	 * return girlResult; }
	 */
	...
	public Girl girlUpdate(@PathVariable("id") Integer id, @RequestParam("cupSize") String cupSize,
			@RequestParam("age") Integer age, @RequestParam("money") Long money) {
		Girl girl = new Girl();
		girl.setId(id);
